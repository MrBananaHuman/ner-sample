...
from transformers import BasicTokenizer, PreTrainedTokenizer, Pipeline, ModelCard, is_tf_available, is_torch_available

from transformers.pipelines import ArgumentHandler, TokenClassificationArgumentHandler
        ...
        for sentence in inputs:
            ...
            with self.device_placement():
                ...
                tokens, words, tokens_mask = custom_encode_plus(
                    sentence, self.tokenizer, return_tensors=self.framework
                )
